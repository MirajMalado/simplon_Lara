...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-white fw-bold">
            <div class="container">
                <a class="navbar-brand" href="#" title="Logo Simplon">
                    <img src="img/simplonSN.png" alt="Logo Simplon" width="150" class=" d-inline-block align-text-top">
                </a>
    ...
    <main class="container-fluid ">
        <figure>
            <img src="img/formationsproBestResolution.jpg" alt="Banner" class="img-fluid">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="menu secondary-menu position-fixed d-md-none secondary-menu-public sp-hidden-left">
                            <p
                                ...
                                <span class="d-flex align-items-center">
                                    <object type="image/svg+xml" data="img/SVG/IconFemmeBlanc.svg"
                                        title="icon"></object>
                                </span>
                                Femme
                            </p>
                            <p
                                ...
                                <span class="d-flex align-items-center">
                                    <object type="image/svg+xml" data="img/SVG/IconDiscoverBlanc.svg"
                                        title="icon"></object>
                                </span>
                                Kids
                            </p>
                            ...
                            <div class="left-bloc my-4 d-flex align-items-center  align-items-sm-start ">
                                ...
                                <div class="menu flex-column menu-public">
                                    ...
                                    <p
                                        ...
                                        <span class="d-flex align-items-center">
                                            <object type="image/svg+xml" data="img/SVG/IconKidsblanc.svg"
                                                title="icon"></object>
                                        </span>
                                        Kids
                                    </p>
                                    <p
                                        class="align-items-center d-flex my-4 p-1 pe-md-3 rounded-pill rounded-start shadow-sm">
                                        <span class="d-flex align-items-center">
                                            <object type="image/svg+xml" data="img/SVG/IconPshblanc.svg"
                                                title="icon"></object>
                                        </span>
                                        PSH
                                    </p>
                                    <p
                                        ...
                                        <span class="d-flex align-items-center">
                                            <object type="image/svg+xml"
                                                data="img/SVG/IconDiscoverBlanc.svg" title="icon"></object>
                                        </span>
                                        Refugies
                                    </p>
                                </div>
                        ...
                        <div class="col-md  col-sm-12">
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3">
                                ...
                                <div class="my-3 justify-content-center ">
                                    <div class="card shadow-sm h-100 text-center sp-rounded-top-15 sp-rounded-bottom-15">
                                        <img src="img/emailing.jpg" class="card-img-top sp-rounded-top-15"
                                ...
                                <div class="my-3 justify-content-center ">
                                    <div class="card shadow-sm h-100 text-center sp-rounded-top-15 sp-rounded-bottom-15">
                                        <img src="img/seo.jpg" class="card-img-top sp-rounded-top-15"
                    ...
                    <div class="row align-items-center p-relative">
                        ...
                        <div class="menu secondary-menu position-fixed d-md-none secondary-menu-parcours">
                            ...
                            <p
                                class="align-items-center d-flex p-1 pe-md-3 rounded-pill rounded-start shadow-sm">
                                <span class="d-flex align-items-center">
                                    <object type="image/svg+xml" data="img/SVG/father-svgrepo-com.svg"
                                        title="icon"></object>
                                </span>
                                Initiation
                            </p>
                            <p
                                class="align-items-center d-flex p-1 pe-md-3 rounded-pill rounded-start shadow-sm">
                                <span class="d-flex align-items-center">
                                    <object type="image/svg+xml" data="img/SVG/IconOrienteMetierBlanc.svg"
                                        title="icon"></object>
                                </span>
                                Metier
                            </p>
                            ...
                            <div class="left-bloc my-4 d-flex align-items-center  align-items-sm-start  ">
                                ...
                                <div class="menu flex-column menu-parcours">
                                    ...
                                    <p
                                        ...
                                        <span class="d-flex align-items-center">
                                            <object type="image/svg+xml"
                                                data="img/SVG/father-svgrepo-com.svg"
                                                title="icon"></object>
                                        </span>
                                        Initiation
                                    </p>
                                    <p
                                        ...
                                        <span class="d-flex align-items-center">
                                            <object type="image/svg+xml"
                                                data="img/SVG/IconOrienteMetierBlanc.svg"
                                                title="icon"></object>
                                        </span>
                                        Metier
                                    </p>
                    ...
                    <div class="row me row-cols-1 row-cols-sm-2 row-cols-md-3 ">
                        <div class="my-3  justify-content-center ">
                            <div class="card shadow-sm h-100 text-center sp-rounded-top-15 sp-rounded-bottom-15">
                                <div class="card-header sp-bg-red  sp-rounded-top-15">
                                    ...
                                    <img class="dropdown-icon" src="img/SVG/dropdown-svgrepo-com.svg"
                                        width="30" height="30" alt="dropdown icon">
                                </div>
                                <div class="card-body sp-rounded-bottom-15">
                                    <img class="logo-partenaire my-3 img-fluid"
                                        src="img/miscrosoftLogo.png" width="150" alt="logo microsoft">
                                    <p class="card-text">
                        ...
                        <div class="my-3  justify-content-center ">
                            <div class="card shadow-sm h-100 text-center sp-rounded-top-15 sp-rounded-bottom-15">
                                ...
                                <div class="card-body sp-rounded-bottom-15">
                                    <img class="logo-partenaire my-3 img-fluid" src="img/IESELogo.png"
    ...
    <footer class="sp-footer ">
        <div class="row pt-5 mt-5 text-white d-inline-block row-cols-1 row-cols-sm-2 row-cols-lg-4 d-sm-flex justfy-sm-content-around w-100 gap-0 gap-sm-0 ps-5">
            <div class="logo-icons col col ps-md-0 px-lg-0  my-2 d-lg-flex text-sm-start">
                <img src="img/logoWhiteSimplon.svg"  class="mx-lg-auto mx-auto mx-sm-0" alt="Logo simplon format blanc" width="150">
